    ...
    return (
        <div class="container-fluid pb-2 pt-3">
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        this Agreement) refers to Mad Libs Diceware.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        ...
                        <a href="https://www.termsfeed.com/terms-conditions-generator/"> Terms and Conditions Generator </a>.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Mad Libs Diceware, accessible
                        from <a href="https://mad-libs-diceware.netlify.app/"> https://mad-libs-diceware.netlify.app/</a>
                    </p>
                </li>
                <li>
                    <p>
            ...
            <p>
                ...
                contact us by email at rutuparn.pawar@outlook.com
            </p>
        </div>
    );
}
